...
;; Last update Mon Oct 17 10:23:39 2011 Raphael Balouka
;;
;; Based on Comment routines by Isaac
;;

(setq login "moulin_e")
(setq name "MOULINETTE Edouard")
...
(setq header-made-by    "Made by "
      ...
      header-for    " for "
      header-in        " in "
      domaine-name    "etna-alternance.net"
      user-nickname  name)
...
(setq std-c-alist               '( (cs . "/*") (cc . "** ") (ce . "*/") )
      ...
      std-perl-alist            '( (cs . "#!/usr/bin/env perl -w")  (cc . "## ")(ce . "##"))
      std-cperl-alist           '( (cs . "#!/usr/bin/env perl -w")  (cc . "## ")(ce . "##"))
      )
